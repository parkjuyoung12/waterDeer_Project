							...
							<div class="card-body">
								<div class="container" role="main">
									<div class="subject-container">
										...
										<span> 과목 코드: </span>
										<input 	type="text" placeholder="과목 코드" readonly
												id="subj_code">
									</div>
									<div class="classroom-container">
										<select name="room_code" id="room_code">
											<c:forEach var="roomDTO" items="${roomList}">
														<option value="${roomDTO.room_code}">${roomDTO.room_name}</option>
											</c:forEach>
										</select>
										<span>강의실 인원: </span>
										<input type="text" value="강의실 인원" name="room_stud_size" id="room_stud_size" />
									</div>
									<div>
										<div class="modal">
									...
									<div style="display:flex; flex-direction: column; justify-content: flex-end; align-items: flex-end;
										...
										<button id="commitLectureBtn">강의 등록 완료</button>
									</div>
								</div>
							</div>
						</div>
