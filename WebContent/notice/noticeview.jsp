			...
			<div class="container-fluid">
				...
				<div class="row">
					...
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">상세내용(공지)</h4>
								<div class="table-responsive">
									<table class="table">
										<thead>
											<tr>
												<th>글번호</th>
												<td>${noticeBoard.num}</td>
												<th>날짜</th>
												<td>${noticeBoard.indate}</td>
											</tr>
											...
											<div class="mb-3">
												...
												<!-- <input class="form-control" rows="5" name="content"
													id="content"></input> -->
												<c:if test='${loginUser.member_position == "PROF"}'>
													<form id="notice_view_btn_form" style="display: flex; flex-direction: row; justify-content: flex-end;"
															action="noticeeditform.myuk" method="post" onsubmit="onSubmitAction()">
													<input type="hidden" id="num" name="num" value="${noticeBoard.num}">
														<span><input type="submit" class="btn btn-sm btn-primary" value="수정" onclick="goToEditForm(this)"
																	style="margin-right: 5px;"></span>
															<span><input type="button" class="btn btn-sm btn-primary" value="삭제" onclick="ckAndDelete(this)"></span>
													</form>
												</c:if> 
											</div>
								</div>
