...
<body class="fix-header card-no-border fix-sidebar">
	...
	<div id="main-wrapper">
		...
		<div class="page-wrapper">
							...
							<div class="card-body">
								<div class="container" role="main">
									...
									<div>
										<div class="modal">
											<div class="modal_positioner">
												<button id="modal_onper">과목 조회</button>
												<div class="subj_list">
													<table>
														<thead>
															<tr>
												...
												<div class="search-container-subj">
													<input type="text" placeholder="과목 이름을 입력하세요.">
													<div class="search-button-grp">
														<input type="button" id="search" value="과목 조회" />
									...
									<table class="time-table" id="sda">
										...
										<c:forEach var="course" items="${CourseDTO}" varStatus="status">	
											<tr>
												<input type="radio"> <th>${status.subj_code}</th></input>
												<th>${status.course_code}</th>
												<th>${status.subj_name}</th>
												<th>${status.room_name}</th>
												<th>${CourseDTO.prof_name}</th>
												<th>${CourseDTO.time_table}</th>
												<th>${CourseDTO.course_stud_lim}</th>
											</tr>
											</c:forEach>
									...
									<div>
											<button id="subj_name"  style="border-right: window; float:right; padding-right: 10px;">수강 취소</button>
											</div>
									<div class="subject-container">
										<input type="text" id="name" name="name" placeholder="과목명 입력" required
      									 minlength="4" maxlength="30" size="30">
										<button id="modal"  >과목 조회</button>
										<button id="subj_name" >수강 등록</button>
									</div>
								</div>
							</div>
						</div>
			...
			<script src="js/credit/selectcredit.js"></script>
</body>
