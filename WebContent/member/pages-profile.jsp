							...
							<div class="card-body">
								<center class="mt-4">
									<img src="./assets/images/users/5.jpg" class="img-circle"
										width="150" />
									<h4 class="card-title mt-2">1${MemberDTO.member_name}</h4> <!-- FIXME 회원이름, 학과 출력 -->
									<h6 class="card-subtitle">${MemberDTO.dept_code}</h6>
									<div class="row text-center justify-content-md-center"></div>
									<button class="btn btn-success">이미지 변경</button>
									<c:if
										test="${not empty selBoardView.fileName && selBoardView.fileName != 'null'}">
										<tr>
											<td width="150" align="center" bgcolor="#FF9933" rowspan="2">이미지</td>
											<td><input type="hidden" name="originalFileName"
												value="${selBoardView.fileName}"> <img
												alt="image_preview"
												src="imagePreView.bizpoll?articleno=${selBoardView.articleno}&fileName=${selBoardView.fileName}"
												id="preview" style="width: 100px; height: 100px;"><br>
											</td>
										</tr>
										<td><input type="file" name="fileName" id="i_fileName"
											disabled="disabled" onchange="readURL(this);"></td>
									</c:if>
								</center>
							</div>
						</div>
							...
							<div class="card-body">
								<form class="form-horizontal form-material mx-2">
									<div class="form-group">
										<label class="col-md-12">School No</label>
										<div class="col-md-12">
											<input type="text" placeholder="${member_numb}"
												class="form-control form-control-line" disabled="disabled">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-12">Password Update</label>
										<div class="col-md-12">
