...
<body class="fix-header card-no-border fix-sidebar">
					...
					<div class="col-12">
						<div class="card">
									...
									<td colspan="5" align="center">
										<form action="boardList.myuk" method="get">
											<select name="searchType" id="searchType" >
												<option value="t"
													<c:out value="${boardInfo.searchType == 't' ? 'selected' : '' }"/>>제목</option>
												<option value="c"
													<c:out value="${boardInfo.searchType == 'c' ? 'selected' : '' }"/>>내용</option>
												<option value="w"
													<c:out value="${boardInfo.searchType == 'w' ? 'selected' : '' }"/>>글쓴이</option>
												<option value="tc"
													<c:out value="${boardInfo.searchType == 'tc' ? 'selected' : '' }"/>>제목+내용</option>
												<option value="tcw"
													<c:out value="${boardInfo.searchType == 'tcw' ? 'selected' : '' }"/>>제목+내용+글쓴이</option>
							...
							<button type="button" class="btn btn-sm btn-primary" id="btnSave"
								onClick="location.href='#'" style="width: 10%; float: rigth;">글쓰기</button>
						</div>
					</div>
				</div>
				<!-- ============================================================== -->
	...
	<!--Wave Effects -->
	<script src="./jss/waves.js"></script>
	<!--Menu sidebar -->
