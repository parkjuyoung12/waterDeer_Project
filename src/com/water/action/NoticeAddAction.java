...
public class NoticeAddAction implements Action{
	...
	public ActionFoward excute(HttpServletRequest request, HttpServletResponse response)
		...
		String url = "noticeList.myuk" ;
		if(course_code != null)  // 당연히 NOT NULL이어야 하지만.
		{
			url += "?course_code="+course_code; // 현개 강좌의 게시글 목록
		} else {
			System.out.println("\n\n\n[NoticeAddAction] course_code IS NULL.\n\n\n");
		...
		// String course_code = request.getParameter("course_code");
		boolean successful = dao.insertNotice(title, content, img_path, img_name, course_code);
